...
let storyText = `It was 94 farenheit outside, so :insertx: went for a walk. When they got to :inserty:,
 they stared in horror for a few moments, then :insertz:. Bob saw the whole thing, 
but he was not surprised — :insertx: weighs 300 pounds, and it was a hot day.`;
...
function result() {
	...
	var xReplace = /:insertx:/gi;
	newStory = newStory.replace(xReplace, xItem);
  ...
  if(document.getElementById("metric").checked) {
		...
		newStory = newStory.replace('94 farenheit',temp.toFixed(2)+ " celcius");
  }
	...
	/* STEP 13: Make the textContent property of the story variable (which references the paragraph) equal to newStory */
	  ...
	  container.insertAdjacentHTML('afterbegin','<br><div class="card-body"><p class="story"></p></div>')
